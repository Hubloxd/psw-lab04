    ...
    partial class LoginForm
    {
        ...
        private async void BtnLogin_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (user == null)
                {
                    MessageBox.Show("Nieprawidłowe dane logowania lub konto zablokowane.", "Błąd", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
                ...
                if (user.Permissions == 0)
                {
                    ...
                    throw new NotImplementedException("Panel administratora nie został jeszcze zaimplementowany.");
        ...
        {
            var serviceProvider = Program.ServiceProvider;
            throw new NotImplementedException("Rejestracja nie została jeszcze zaimplementowana.");
